...
const fields=["inputFolder","outputFolder","platform","style","variants","filenamePattern","productName","productCategory","scriptMode","scriptAngle","subtitlePreset","motionPreset","hook","benefit","cta","voiceEnabled","voiceProvider","voiceName","voiceRate","voiceFallback","musicEnabled","musicFile"];
let timer;
